...
<body class="g-sidenav-show  bg-gray-200" style="font-family: Noto sans Lao">
  ...
  <div class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ route('admin.index') }}">
        ...
        <span style="color: rgb(211, 0, 70);font-size:20px;text-align:center" class="ms-3 font-weight-bold">Hi 
          <img class="rounded-circle" src="{{ asset('storage/images/profiles/'.Auth::user()->image) }} " width="38%" alt=""></span>
      </a>
    </div>
    ...
    <div style="height:80%" class="collapse navbar-collapse" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
            <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">ຈັດການຂໍ້ມູນ</h6>
          </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white @yield('rent_room') " href="{{ route('admin.rent_room.index') }}">
            ...
            <span class="nav-link-text ms-1">ບໍລິການເຊົ່າຫ້ອງ</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white @yield('elect') " href="{{ route('admin.electric.index') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-plug-circle-plus"></i>
            </div>
            <span class="nav-link-text ms-1">ຈັດການຂໍ້ມູນບິນໄຟຟ້າ</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white @yield('water') " href="">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-faucet-drip"></i>
            </div>
            <span class="nav-link-text ms-1">ຈັດການຂໍ້ມູນບິນນ້ຳປະປາ</span>
          </a>
        </li>
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
				<form action=" @yield('searchUser')" method="get" class="navbar-search" >
					<div class="input-group input-group-outline">
					<label class="form-label">ຄົນຫ້າ...</label>
          ...
          <ul  class="navbar-nav  justify-content-end">   
                    ...
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                            <span class="font-weight-bold">ການເເຈ້ງເຕືອນໃໝ່</span> ຈາກ ບັນດາ
                        </h6>
            ...
            <li style="padding: 0 20px" class="nav-item d-flex align-items-center">
              <a class="nav-link text-body font-weight-bold px-0" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <i style="color: rgb(255, 0, 98)" class="fa-solid fa-right-from-bracket"></i>
                <span style="color: rgb(255, 0, 98)"  class="d-sm-inline d-none">ອອກຈາກລະບົບ</span>
              </a>
            </li>
  ...
  <script>
    ...
    new Chart(ctx3, {
      type: "line",
      data: {
        labels: ["ມັງກອນ", "ກຸມພາ", "ມີນາ", "ພຶດສະພາ", "ມີຖຸນາ", "ກໍລະກົດ", "ສິງຫາ", "ກັນຍາ", "ຕຸລາ", "ພະຈິກ", "ທັນວາ"],
        datasets: [{
          label: "Mobile apps",
          tension: 0,
          borderWidth: 0,
