                    ...
                    <div class="col-md-12 mb-lg-0 mb-4">
                        <div class="card mt-4">
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    <div class="col-6 d-flex align-items-center">
                                        <h6 class="mb-0">ປະຫວັດການເຊົ່າ & ຕໍ່ເວລາການເຊົ່າ</h6>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div style="padding-top: 2%" class="col-md-12">
                                        <li class="list-group-item rounded-lg">
                                            <form action="{{ route('Customer.rent.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <div class="input-group mb-4 input-group-static">
                                                                <label>ປ້ອນຈຳນວນເງິນທີ່ຈ່າຍ</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group input-group-dynamic mb-4">
                                                            <div class="input-group mb-4 input-group-static">
                                                                <label>ເລືອກຮູບບິນທີ່ຈ່າຍ</label>
