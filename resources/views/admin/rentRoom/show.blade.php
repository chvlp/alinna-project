                                        ...
                                        @if ($item->rentRoom_id == $rentRooms->id)
                                            <div style="font-family:'Notopadding-top: 2%" class="col-md-12 mb-md-0 mb-4 pt-3">
                                                <div
                                                    ...
                                                    <div class="ms-auto w-30 d-flex align-items-end justify-content-end">
                                                        <div class="d-flex">
                                                            <h5 style="font-family: 'Noto sans Lao';color:red;padding-right:5px;margin-top:16px">ຈ່າຍແລ້ວ</h5>
                                                            <i style="padding-left:4px;margin-top: 14px;font-size:30px" class="fa-solid fa-pen-to-square"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg"
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="mb-2 text-xs">ເຈົ້ງຂອງບິນ: <span
                                            class="text-dark font-weight-bold ms-sm-2">
                                            {{ $rentRooms->member->user->gender }}
                                            {{ $rentRooms->member->user->name }}</span></span>
                                    <span class="mb-2 text-xs">ບິນຂອງຫ້ອງ: <span
                                            class="text-dark ms-sm-2 font-weight-bold">{{ $rentRooms->room->number }}</span></span>
                                    <span class="text-xs">ຕົວເລກຄັ້ງນີ້: <span
                                            class="text-dark ms-sm-2 font-weight-bold">755</span></span>
                                    <span class="text-xs">ຕົວເລກຄັ້ງກ່ອນ: <span
                                            class="text-dark ms-sm-2 font-weight-bold">752</span></span>
                                ...
                                <div class="ms-auto text-end">
                                    ...
                                    <h1 style="font-family: 'Noto sans Lao">{{ Now() }}</h1>
                                </div>
                            </li>
                        </ul>
                    </div>
